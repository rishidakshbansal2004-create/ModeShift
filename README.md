...
| Roast&Boost My Resume | `gemini-3.1-flash-lite` | Leans on tone/creativity more than deep multi-step reasoning; lighter model is sufficient and faster. |
...
| Avg. latency — Resume Roast (PDF input) | ~12s |
